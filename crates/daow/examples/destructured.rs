...
use daow::{async_trait, dao, Entity, ExecuteResult, FromSqlColumn, Pool, Result, ToSqlColumn};
...
impl FromSqlColumn for ProductId {
    fn from_column(value: &daow::ColumnValue) -> Result<Self> {
