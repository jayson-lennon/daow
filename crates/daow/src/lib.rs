...
//!
//! `daow` validates SQL by compiling your DAO traits against an actual SQLite
//! database. You point the build at one with the `DAOW_DATABASE_URL` environment
...
//! without a schema. See [`docs/guide.md`](https://github.com/jayson-lennon/daow/blob/main/docs/guide.md)
...
///
/// See the [crate-level docs](crate) for the `DAOW_DATABASE_URL` requirement.
pub use daow_macros::{dao, Entity};
